...
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,py,php,laravel,java,dart,flutter,nodejs,react,angular,express,nestjs,django,sass,tailwind,bootstrap,git,github,bash,mysql,sqlite,mongo,supabase,prisma,postman,vercel" />
</p>
