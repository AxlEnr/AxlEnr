...
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,py,java,dart,flutter,nodejs,react,angular,express,nestjs,django,sass,tailwind,bootstrap,git,github,bash,ubuntu,mysql,sqlite,azure,prisma,type,postman,netlify,vscode,androidstudio" />
</p>
